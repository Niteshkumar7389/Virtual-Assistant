...
const SignUp = () => {
  ...
  return (
    ...
    >
      <form
        className="w-[90%] h-[600px] max-w-[500px] bg-[#00000000] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-4 px-5 "
        action=""
        onSubmit={handleSignUp}
      >
        <h1 className="text-white text-3xl font-semibold mb-8">
          SignUp for <span className="text-sky-300">Virtual Assistance</span>
        </h1>
        <input
          type="text"
        ...
        <input
          type="email"
          className="w-full h-14 outline-none bg-transparent border-2 text-white text-md placeholder-gray-300 px-5 rounded-full mb-8"
